...
| `git-pr` | PR and MR workflows for GitHub (gh) and GitLab (glab): creation, review, comments, Copilot review loop, merging | `bunx skills add dmythro/agent-skills --skill git-pr` <br> `npx skills add dmythro/agent-skills --skill git-pr` |
