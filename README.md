...
| `git-pr` | PR and MR workflows for GitHub (gh) and GitLab (glab): creation, review, comments, bot review loop (Copilot, CodeRabbit), merging | `bunx skills add dmythro/agent-skills --skill git-pr` <br> `npx skills add dmythro/agent-skills --skill git-pr` |
